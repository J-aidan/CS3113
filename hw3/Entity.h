...
enum EntityType { SAFEPLATFORM, UNSAFEPLATFORM, PLAYER, ENEMY  };
...
public:
    ...
    void move_left() { m_acceleration.x = -.1f; }
    void move_right() { m_acceleration.x = .1f;     }
    void move_up() { m_acceleration.y = .1f;       }
    void move_down() {  }
    ...
    bool      const get_flying() const { return m_still_flying; }
    bool      const get_mission_success() const { return m_player_mission_success; }
    ...
    void const set_flying(bool new_flying) { m_still_flying = new_flying; }
    void const set_mission_success(bool new_success){ m_player_mission_success = new_success; }
